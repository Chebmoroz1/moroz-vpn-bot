...
# Telegram OIDC (новый Login-флоу, заменивший telegram-widget.js).
# TELEGRAM_OIDC_CLIENT_SECRET получается в @BotFather: выбрать бота -> Bot Settings -> Web Login.
# Это НЕ BOT_TOKEN — использование BOT_TOKEN как client_secret даёт invalid_client.
